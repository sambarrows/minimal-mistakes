...
excerpt: 'With k-Means and lasso regression, using Python.' 
---
...
```
    ...
    train time (seconds): 182.654426098
...
```
    ...
    trains time (seconds): 4.09790897369
...
```
    ...
    trains time (seconds): 11.3451271057
